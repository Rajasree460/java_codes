...
class Complex { 
    ...
    public void Display(Complex C1, Complex C2) { 
        System.out.println("First Complex Numbers=(" + C1.real + ")+(" + C1.img + ")i"); //printing first complex number 
    ...
    public void SubNumbers(Complex C1, Complex C2) { //substraction of two complex number 
        ...
        real = (C1.real - C2.real); //real part of complex number 
        img = (C1.img - C2.img); //img part of complex number 
        System.out.println("Substraction of Complex Numbers = ("+real+") + ("+img+")i"); //priting substraction of two complex number 
    } 
    ...
    public void MultiNumbers(Complex C1, Complex C2) { //multiplication of two complex number 
        ...
        System.out.println("Multiplication of Complex Numbers = ("+real+") + ("+img+")i"); //printing multiplication of two complex number 
    }

    /*public void DivNumbers(Complex C1, Complex C2) { //division of two complex number 
        float real, img; 
        real = (C1.real * C2.real + C1.img * C2.img) / (C2.real * C2.real + C2.img * C2.img); //real part of complex number 
        img = (C1.img * C2.real - C1.real * C2.img) / (C2.real * C2.real + C2.img * C2.img); //img part of complex number 
